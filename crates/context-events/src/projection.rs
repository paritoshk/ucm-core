...
use context_core::entity::ContextEntity;
use context_core::edge::ContextEdge;
...
impl GraphProjection {
    ...
    pub fn replay_all(events: &[ContextEvent]) -> ContextGraph {
    ...
    pub fn apply_event(graph: &mut ContextGraph, event: &ContextEvent) {
        match &event.payload {
    ...
    pub fn apply_batch(graph: &mut ContextGraph, events: &[ContextEvent]) {
        for event in events {
...
mod tests {
    ...
    use context_core::edge::RelationType;
    

    #[test]
    fn test_replay_builds_graph() {
        let events = vec![
            ContextEvent::new(EventPayload::EntityDiscovered {
            ...
            ContextEvent::new(EventPayload::DependencyLinked {
